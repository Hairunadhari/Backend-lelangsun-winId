...
//         // route toko
//         Route::get('/toko', [MenuSuperAdminController::class, 'list_toko'])->name('admin.toko');
//         Route::post('/addtoko', [MenuSuperAdminController::class, 'add_toko'])->name('admin.addtoko');
//         Route::get('/edittoko/{id}/', [MenuSuperAdminController::class, 'edit_toko'])->name('admin.edittoko');
//         Route::get('/detailtoko/{id}/', [MenuSuperAdminController::class, 'detail_toko'])->name('admin.detailtoko');
//         Route::put('/updatetoko/{id}/', [MenuSuperAdminController::class, 'update_toko'])->name('admin.updatetoko');
//         Route::put('/deletetoko/{id}/', [MenuSuperAdminController::class, 'delete_toko'])->name('admin.deletetoko');
//         Route::put('/activetoko/{id}/', [MenuSuperAdminController::class, 'active_toko'])->name('admin.activetoko');
