        ...
        columns: [
          ...
          render: function (data) {
            ...
            },
            {
                data: null,
          render: function (data) {
            var deleteUrl = '/superadmin/delete-banner-spesial/' + data.id;
            var editUrl = '/superadmin/edit-banner-spesial/' + data.id;
            return `
...
<div class="modal fade" id="bannerspesial" tabindex="-1" role="dialog" aria-labelledby="bannerspesialLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('superadmin.add-banner-spesial')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Gambar <small>(png, jpg, jpeg, disarankan: width 250px, height 140px)</small><span style="color: red">*</span></label>
