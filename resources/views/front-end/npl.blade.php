                     ...
                     <div class="container-fluid">
                         ...
                         <div class="collapse navbar-collapse" id="navbarSupportedContent">
                             <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                 ...
                                 <li class="nav-item">
                                     <a class="{{ request()->routeIs('front-end-npl') ? 'active text-white' : '' }} nav-link"
                                         href="{{route('front-end-npl')}}">NPL</a>

                                 </li>
                                 <li class="nav-item">
                                     <a href="{{route('front-end-pelunasan')}}" class="nav-link">Pelunasan Barang
                                         Lelang</a>
                                 </li>
                                 <li class="nav-item">
                                 ...
                                 <form action="{{route('add-npl-user')}}" method="post" enctype="multipart/form-data">
                                     ...
                                     <div class="modal-body">
                                         ...
                                         <div class="form-group mb-3">
                                             ...
                                             <input type="number" class="form-control" id="jumlahNpl"
                                                 name="jumlah_tiket" required>
                                         </div>
                                         <div class="form-group mb-3">
                                         ...
                                         <div class="form-group mb-3">
                                             <label>No Rekening Anda <span style="color: red">*</span></label>
                                         ...
                                         <div class="form-group mb-3">
                                             ...
                                             <input type="file" class="form-control" name="bukti" required
                                                 accept=".jpg,.png,.jpeg" id="gambarktp">
                     ...
                     <table class="table table-bordered">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td>
                                     @if ($p->status_npl == 'aktif' && $p->event_lelang->waktu < $hours_now || $p->
                                         status_npl == 'aktif' && $p->event_lelang->status_data == 0)
                                         <form action="{{route('user-refund', $p->id)}}" method="POST"
                                             onsubmit="return confirm('Apakah anda yakin akan melakukan refund ?');">
                 ...
                 $.ajax({
                     ...
                     success: function (res) {
                         ...
                         var formattedNumber = parseFloat(res).toLocaleString(
                             'id-ID'
                             ); // Ganti 'id-ID' sesuai dengan kode bahasa yang sesuai
                         ...
                         $('#jumlahNpl').on('input', function () {
                             ...
                             if (!isNaN(jumlahNpl)) {
                                 ...
                                 $('#nominalTransfer').val(totalHarga
                                     .toLocaleString(
                                         'id-ID'));
                             } else {
