        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <div class="form-group">
                        <label>Diskon (%)</label>
                        <input type="text" class="form-control" name="diskon" value="{{old('diskon', $data->diskon)}}"
                            onkeyup="formatPromo(this)">
                    </div>
                    <div class="form-group">
                            ...
                            <table class="table table-bordered" id="tabel1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="ms-auto" src="{{ asset('storage/image/'.$p->thumbnail) }}"
